...
// Shared HLSL pass helpers (semantic patching, entry-point wrapping, shader names) live in
// EffectCompilerHLSLShared.cpp so the Vulkan compiler can use them too.
