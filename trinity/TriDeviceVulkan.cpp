...
// Frame loop for the Vulkan platform, following TriDeviceMetal.cpp: skip/throttle, upscaler reset, update, present,
// render. mDeviceLost is expected to be set by the backend on VK_ERROR_DEVICE_LOST.
